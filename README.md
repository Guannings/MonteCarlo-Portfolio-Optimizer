...
The complete first-principles derivation of every formula used in the code — daily returns, covariance, portfolio volatility (**wᵀΣw**), Geometric Brownian Motion and the Itô correction, CAGR, the Sharpe ratio, the √T volatility rule, and percentile confidence intervals — lives in the project Wiki:

📐 **[Full Mathematical Derivations →](https://github.com/Guannings/MonteCarlo-Portfolio-Optimizer/wiki/Mathematical-Derivations)**
